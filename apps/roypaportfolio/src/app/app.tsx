...
The result is a realistic, production-shaped reference implementation of hospital operations software — useful both as a working clinic management tool and as a demonstration of layered backend architecture (routes → controllers → services → repositories), role-based access control design, and transactional business logic in a healthcare domain.`,
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-hidden">
      ...
      <section
        id="home"
        className="relative  bg-gray-900/30 min-h-screen flex items-center px-8 py-24 lg:px-16"
      >
        {/* Background Elements */}
      ...
      <section id="about" className="relative px-8 py-24 lg:px-16">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="text-sm text-emerald-400 uppercase tracking-[0.3em] mb-4 font-medium">
              About Me
            </div>
          ...
          <div className="space-y-6 md:px-[150px] ">
            <p className="text-lg text-gray-300 leading-relaxed font-light">
              I’m a passionate web and mobile developer with 4 years of
              experience building modern, scalable applications. My core
              expertise lies in React with Redux for web development, and
              Flutter with BLoC for mobile apps. I focus on creating responsive,
              high-performance interfaces and seamless user experiences.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed font-light">
              I’m naturally curious and constantly learning, always striving to
              improve my skills and write cleaner, more efficient code. Whether
              it’s a website, a mobile app, or anything in between—I love
      ...
      <section
        id="skills"
        className="relative px-8 py-24 lg:px-16 bg-gray-900/30"
      >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <Card className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 hover:border-emerald-500/30 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-400 text-sm">
                    Crafting responsive, scalable web interfaces using React and
                    Redux
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 hover:border-emerald-500/30 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-400 text-sm">
                    Building smooth and performant cross-platform apps with
                    Flutter and BLoC
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 hover:border-emerald-500/30 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-400 text-sm">
                    Implementing robust state logic for complex applications
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 hover:border-emerald-500/30 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-400 text-sm">
                    Always improving and exploring better ways to build with
      ...
      <section id="projects" className="relative px-8 py-24 lg:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="text-sm text-emerald-400 uppercase tracking-[0.3em] mb-4 font-medium"></div>
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">
              Personal Projects
            </h2>
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mx-auto">
              Here are some of my personal projects that showcase my skills and
              creativity.
            </p>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex space-x-4 pt-8">
                <Button
                  ...
                  onClick={() =>
                    window.open('https://github.com/roypa123', '_blank')
                  }
                >
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      'https://www.linkedin.com/in/roypa123',
                      '_blank'
                    )
                  }
                >
